  ...
  <div>
    <section class="mb-10 max-w-3xl">
      ...
      <h1 class="mb-4 text-[clamp(2.1rem,5vw,3.6rem)] font-bold leading-tight tracking-tight text-slate-50">
        ...
        <span class="bg-gradient-to-r from-emerald-300 to-cyan-300 bg-clip-text text-transparent">guided in-app walkthroughs</span>
      </h1>
      <p class="max-w-2xl text-base leading-7 text-slate-400">
        Upload your manual, review extracted steps, test the flow in a live preview, and export production-ready snippets.
      </p>
    </section>
